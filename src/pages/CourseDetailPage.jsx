...
const Toast = ({ message, type = "info", onClose }) => {
  ...
  return (
    <div
      className={`${courseDetailCustomStyles.toast} ${
        type === "error"
          ? courseDetailCustomStyles.toastError
          : courseDetailCustomStyles.toastInfo
      }`}
    >
      <div className={courseDetailCustomStyles.toastContent}>
        <span>{message}</span>
        <button
          onClick={onClose}
          className={courseDetailCustomStyles.toastClose}
        >
          <X className={courseDetailCustomStyles.toastCloseIcon} />
        </button>
      </div>
    </div>
  );
...
const CourseDetailPage = () => {
  ...
  // NO auto-selection on load — user chooses manually
  ...
  // inititalize enrollment state based on whether course is free
  useEffect(() => {
    if (isCourseFree) {
      setIsEnrolled(true);
    } else {
    ...
    return (
      <div className={courseDetailStyles.notFoundContainer}>
        ...
        <div className={courseDetailStyles.notFoundContent}>
          <div
            className={`${courseDetailStyles.notFoundBlob} top-10 left-10 bg-purple-300`}
          ></div>
          <div
            className={`${courseDetailStyles.notFoundBlob} top-10 right-10 bg-yellow-300 ${animationDelays.delay300}`}
          ></div>
          <div
            className={`${courseDetailStyles.notFoundBlob} bottom-10 left-20 bg-pink-300 ${animationDelays.delay700}`}
          ></div>
        </div>
      ...
      <div
        className={`${courseDetailStyles.mainContainer} ${
          isPageLoaded
            ...
            : courseDetailCustomStyles.containerHidden
        }`}
      >
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className={courseDetailStyles.backText}>
              Back to Home
            </span>
          </button>
        ...
        <div className={courseDetailStyles.header}>
          ...
          <div
            className={`${courseDetailStyles.statsContainer} ${animationDelays.delay300}`}
          >
            ...
            >
              <User className={courseDetailStyles.teacherIcon} />
              <span className={courseDetailStyles.teacherText}>
                {course.teacher}
              </span>
            </div>
          </div>
