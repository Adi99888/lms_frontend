...
export const aboutUsStyles = {
  ...
  // Typography
  mainHeading: "text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 font-serif tracking-tight drop-shadow-lg text-center",
...
export const navbarStyles = {
  navbar: "fixed top-0 inset-x-0 z-50 transition-all duration-500",
  navbarVisible: "translate-y-0 opacity-100",
  navbarHidden: "-translate-y-full opacity-0",

  navbarDefault:
    "bg-gradient-to-r from-blue-50 via-white to-indigo-50 border-b border-blue-100",
  navbarScrolled:
    "bg-white/80 backdrop-blur-xl shadow-sm border-b border-gray-200",

  container: "max-w-7xl mx-auto px-4",
  innerContainer: "h-16 flex items-center justify-between",

  /* LOGO */
  logo: "flex items-center gap-3 cursor-pointer select-none",
  logoImage: "w-10 h-10",
  logoText:
    "text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent font-serif",

  /* DESKTOP NAV */
  desktopNav:
    "hidden lg:flex items-center gap-1 bg-white/70 backdrop-blur-md px-2 py-1 rounded-full border border-gray-200 shadow-sm",
  desktopNavItem:
    "flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-gray-700 transition-all duration-300 hover:bg-blue-50 hover:text-blue-600 hover:scale-[1.03]",
  desktopNavItemActive:
    "bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md scale-[1.05]",

  /* AUTH */
  authContainer: "hidden lg:flex items-center",
  primaryButton:
    "px-5 py-2 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold shadow-md hover:scale-105 transition-all",

  /* MOBILE */
  mobileMenuButton:
    "lg:hidden p-2 rounded-xl bg-white border border-gray-300 shadow-sm hover:bg-blue-50 transition",
  mobileMenu:
    "lg:hidden overflow-hidden transition-all duration-500",
  mobileMenuOpen:
    "max-h-[520px] mt-3 opacity-100",
  mobileMenuClosed:
    "max-h-0 opacity-0",

  mobileNavItem:
    "flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 transition hover:bg-blue-50",
  mobileNavItemActive:
    "bg-blue-100 text-blue-700 font-semibold",

  mobilePrimaryButton:
    "mt-4 w-full py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold shadow-md",

  mobileLogoutButton:
    "mt-4 w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-white text-red-600 font-semibold border border-red-200 shadow-sm hover:bg-red-50 transition-all",
};
