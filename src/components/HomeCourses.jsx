...
const HomeCourses = () => {
  ...
  const handleCourseClick = (courseId) => {
    ...
    if (!token) {
      showLoginToast("Please login to access this course");
      return;
    }
          ...
          {visibleCourses.map((course) => {
            ...
            return (
              ...
              >
                ...
                <div className={homeCoursesStyles.courseInfo}>
                  <h3 className={`${detail} ${homeCoursesStyles.teacherInfo}`}>
            ...
            >
              <span className={homeCoursesStyles.ctaButtonContent}>
                <span  className={homeCoursesStyles.ctaText}>
                  ...
                  <ArrowRight size={16} className={homeCoursesStyles.ctaIcon} />
              </span>
            </button>
          </div>
        </div>
