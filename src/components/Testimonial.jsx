...
import testimonial from "../assets/dummyTestimonial";
import {
  BadgeCheck,
  Calendar,
  CalendarDays,
    ...
    <section className={testimonialStyles.section}>
      <div className={testimonialStyles.container}>
        ...
        <p className={testimonialStyles.subtitle}>
          ...
          odio hic consequatur neque veritatis sit! Inventore minima sint
          itaque.
        </p>
      </div>
            ...
            >
              ...
              >
                ...
                <div className={testimonialStyles.courseBadge}>
                  <div className={testimonialStyles.courseBadgeDot} />
                ...
                <div className={testimonialStyles.footer}>
                  <div className={testimonialStyles.verified}>
                    <BadgeCheck
                      size={18}
                      className={testimonialStyles.verifiedIcon}
                    />
                    <span >
                      Verified Student
                    </span>
